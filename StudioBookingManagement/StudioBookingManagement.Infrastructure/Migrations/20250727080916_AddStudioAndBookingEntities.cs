...
{
    /// <inheritdoc />
    public partial class AddStudioAndBookingEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudioType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Amenities = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    ...
                    OpeningHours = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_StudioId_Date_StartTime_EndTime",
                table: "Bookings",
                columns: new[] { "StudioId", "Date", "StartTime", "EndTime" });

            migrationBuilder.CreateIndex(
                name: "IX_Studios_Area",
                table: "Studios",
                column: "Area");

            migrationBuilder.CreateIndex(
                name: "IX_Studios_Latitude_Longitude",
                table: "Studios",
